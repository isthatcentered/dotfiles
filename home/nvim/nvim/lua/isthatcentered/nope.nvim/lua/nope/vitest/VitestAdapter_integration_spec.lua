...
local fixtures_dir = "lua/nope/fixtures/vitest"
local config_path = fixtures_dir .. "/vitest.config.ts"

describe("VitestAdapter integration", function()
  local adapter

  before_each(function()
    adapter = VitestAdapter.new()
  end)
  ...
  describe("single file - passing", function()
    it("captures all passing tests", function()
      local runner = adapter:get_runner({
        ...
        file_path = fixtures_dir .. "/passing.test.ts",
      })
  ...
  describe("single file - failing", function()
    it("captures all failing tests", function()
      local runner = adapter:get_runner({
        configuration_path = config_path,
        file_path = fixtures_dir .. "/failing.test.ts",
      })
  ...
  describe("single file - mixed", function()
    it("captures mixed results correctly", function()
      local runner = adapter:get_runner({
        configuration_path = config_path,
        file_path = fixtures_dir .. "/mixed.test.ts",
      })
  ...
  describe("multiple files", function()
    it("captures all files", function()
      ...
      local passing_file = find_file(state, "passing%.test%.ts")
      local failing_file = find_file(state, "failing%.test%.ts")
      local mixed_file = find_file(state, "mixed%.test%.ts")
